...
Source0  : https://files.pythonhosted.org/packages/49/ef/5298d9d628b6a54b3b810052cb5a935d324fe28d9bfdeb741733d5c2446b/gql-3.5.2.tar.gz
...
%prep
%setup -q -n gql-3.5.2
cd %{_builddir}/gql-3.5.2
pushd ..
cp -a gql-3.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741278894
