...
Source0  : https://files.pythonhosted.org/packages/70/bb/b328e1f39eeab4dcbfb5ee31365e96e41a174478f8d10c877c08bfd688ee/gql-3.4.1.tar.gz
...
%prep
%setup -q -n gql-3.4.1
cd %{_builddir}/gql-3.4.1
pushd ..
cp -a gql-3.4.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684608592
