...
Source0  : https://files.pythonhosted.org/packages/34/ed/44ffd30b06b3afc8274ee2f38c3c1b61fe4740bf03d92083e43d2c17ac77/gql-3.5.3.tar.gz
...
%prep
%setup -q -n gql-3.5.3
cd %{_builddir}/gql-3.5.3
pushd ..
cp -a gql-3.5.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747751052
